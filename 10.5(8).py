# раздел 10.5 Вложенные словари и генераторы словарей
...
result = {key: favorite_numbers[key] for key in favorite_numbers if favorite_numbers[key] in range(10, 100)}
