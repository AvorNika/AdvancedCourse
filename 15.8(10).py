# раздел 15ю8 Анонимные функции, задание 10
...
filtered_numbers = list(map(lambda x: x // 2 if x % 2 == 0 else x, filter(lambda num: (num % 2 == 1 and num <= 47) or (num % 2 == 0), numbers)))
